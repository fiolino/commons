 ...
 * to update the value; it can be held anywhere.
 * <p>
 * You could also wrap the getter handle to a lambda function for easier use; however performance tests have shown
 * that this will result in a performance degradation that is at best comparable with access to direct non-final
 * static variables. Then it would be no use any more to not choose a modifiable static variable instead.
 * <p>
 * You can dismiss the instance of this class after handle creation if you don't need to change the value
 * any more.
 * <p>
