...
public class Types {
   ...
   * Gets a negative distance if subclass and superclass are reversed, and throws an
   * NotAssignableException if the subclass and the superclass are not related at all.
   *
   * @param subType   The sub type
   * @param superType The super type; either a direcct superclass, or an interface
